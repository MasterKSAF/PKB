...
Frontend объединенной версии UI/UX для PKB Neuroassistant. Приложение собрано на React + Vite + MUI и работает в демонстрационном режиме, а также подготовлено к интеграции с Gateway и серверной частью.
...
При подключении серверной части нужно использовать реальные Gateway/API-запросы, сохранив те же пользовательские сценарии.
