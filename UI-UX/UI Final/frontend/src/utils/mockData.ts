...
export const MOCK_ADMIN_USERS: AdminUser[] = [
  ...
  },
  {
    ...
    access: 'База знаний, обработка базы знаний, поиск, история, QA, OCR-артефакты, журналы обработки',
    status: 'Активен',
  ...
  },
  {
    ...
    access: 'Все вкладки, роли, права, полный журнал, обработка базы знаний',
