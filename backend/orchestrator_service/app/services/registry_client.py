...
class RegistryServiceClient(ServiceClient):
    ...
    _SEED_DRAFTS: Dict[int, Dict[str, Any]] = {
        1: {
            ...
            "document_key": "doc-1",
            "original_filename": "ГОСТ 2.105-95.pdf",
            "filename": "ГОСТ 2.105-95.pdf",
            "display_name": "ГОСТ 2.105-95 ЕСКД",
            "status": "uploaded",
            "created_by": "user-1",
        ...
        2: {
            "draft_id": 2,
            "file_key": "drafts/2/file.pdf",
            "document_key": "doc-2",
            "original_filename": "ГОСТ Р 2.106-2019.pdf",
            "filename": "ГОСТ Р 2.106-2019.pdf",
            "display_name": "ГОСТ Р 2.106-2019",
        ...
        3: {
            "draft_id": 3,
            "file_key": "drafts/3/file.pdf",
            "document_key": "doc-3",
            "original_filename": "СТО 002-2023 Трубы.pdf",
            "filename": "СТО 002-2023 Трубы.pdf",
            "display_name": "СТО 002-2023 Трубы",
            "status": "promoted",
            "created_by": "user-1",
    ...
    def _mock_create_draft(storage: dict, body: dict) -> dict:
        ...
        if body.get("original_filename"):
            draft["original_filename"] = body["original_filename"]
            draft["display_name"] = body["original_filename"]
