    ...
    async def call(
        ...
        **kwargs
        ...
        if self.mock_mode or not self.service_url:
            return await self._get_mock_response(method, endpoint, mock_response, **kwargs)
...
class ServiceError(Exception):
    ...
    def _get_code_name(self) -> str:
        ...
        code_names = {
            ...
            403: "FORBIDDEN",
            404: "NOT_FOUND",
            422: "UNPROCESSABLE_FORMAT",
            500: "INTERNAL_SERVER_ERROR",
            503: "SERVICE_UNAVAILABLE"
        }
        return code_names.get(self.status_code, "INTERNAL_SERVER_ERROR")
