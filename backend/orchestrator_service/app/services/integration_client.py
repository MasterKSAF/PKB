...
class IntegrationServiceClient(ServiceClient):
    ...
    async def _generate_mock(
        ...
        # Match /files/{file_id}/info exactly
    ...
    async def upload_file(
        self, file_data: bytes, filename: str, related_document_id: Optional[str] = None
    ) -> Dict[str, Any]:
        ...
        return await self.call(
            "POST", "/files/upload", mock_response={}, files=files, data=data
        )

    async def get_file(self, file_id: str) -> Dict[str, Any]:
        """Get file metadata or binary content."""
        return await self.call("GET", f"/files/{file_id}", mock_response={})
    ...
    async def delete_file(self, file_id: str) -> Dict[str, Any]:
        ...
        return await self.call("DELETE", f"/files/{file_id}", mock_response={})
    ...
    async def get_external_systems_status(self) -> Dict[str, Any]:
        ...
        return await self.call("GET", "/external/status", mock_response={"systems": []})
