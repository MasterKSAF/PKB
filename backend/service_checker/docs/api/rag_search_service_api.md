## API RAG Search Service (rag-search:18091)
...
**Базовый URL (внутренний)**: `http://127.0.0.1:18091/api/v1`
...
| Группа | Описание |
|--------|----------|
| `search` | Поиск релевантных чанков по векторному индексу |
...
| Метод | Путь | Описание |
|-------|------|----------|
| POST | `/rag/search` | Поиск релевантных чанков (без генерации LLM) |
