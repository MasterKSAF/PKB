## API Auth Service (auth-service:18082)

Сервис аутентификации и управления пользователями.

**Базовый URL (внутренний)**: `http://127.0.0.1:18082/api/v1`
...
> **📐 Категории путей:** Все эндпоинты Auth-сервиса сгруппированы по категориям:
> - `/auth/*` — аутентификация и профиль
> - `/admin/*` — управление пользователями, ролями, аудит
>
> Категория соответствует префиксу маршрута в Gateway (см. `gateway_service_api.md`). Пути без категории не используются.
...
| Поле | Тип | Описание |
|------|-----|----------|
| `role_id` | string | Уникальный идентификатор роли |
...
> **⏳ Требует реализации в коде**: эндпоинт для валидации токена. Альтернатива — локальная JWT-верификация без вызова validate. Не входит в объём документации.
