...
| Метод | Путь | Описание |
|-------|------|----------|
| POST | `/files/upload` | Загрузить файл во внешнее хранилище |
| GET | `/files/{file_key}` | Скачать файл |
| DELETE | `/files/{file_key}` | Удалить файл |
| GET | `/files/{file_key}/info` | Метаданные файла без скачивания |
| POST | `/meridian/export` | Экспорт данных в Meridian |
