...
**Generated:** 2026-06-10 08:30:55 UTC
...
| [Registry Service](#registry) | 8084 | ✅ | 35 | 35 | 0 | 0 | ✅ |
| **Total** | | **2/2** | **53** | **53** | 0 | 0 | ✅ |
...
| 3 | POST | `/auth/token` | ✅ OK | 401 | 5ms |
| 4 | GET | `/auth/me` | ✅ OK | 404 | 1ms |
| 5 | POST | `/auth/refresh` | ✅ OK | 401 | 3ms |
| 6 | POST | `/auth/revoke` | ✅ OK | 401 | 3ms |
</details>
...
| 5 | PATCH | `/admin/users/{user_id}` | ✅ OK | 404 | 1ms |
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/registry/classifiers` | ✅ OK | 307 | 2ms |
| 2 | POST | `/registry/classifiers` | ✅ OK | 307 | 4ms |
| 3 | GET | `/registry/classifiers` | ✅ OK | 307 | 3ms |
| 4 | GET | `/registry/classifiers/tree` | ✅ OK | 422 | 3ms |
| 5 | GET | `/registry/classifiers/{classifier_code}` | ✅ OK | 422 | 2ms |
| 6 | PUT | `/registry/classifiers/{classifier_code}` | ✅ OK | 422 | 2ms |
| 7 | PATCH | `/registry/classifiers/{classifier_code}` | ✅ OK | 422 | 2ms |
| 8 | DELETE | `/registry/classifiers/{classifier_code}` | ✅ OK | 422 | 2ms |
| 9 | POST | `/registry/classifiers/import` | ✅ OK | 422 | 3ms |
| 10 | GET | `/registry/classifiers/pending` | ✅ OK | 500 | 6ms |
| 11 | POST | `/registry/classifiers/pending/{pending_id}/accept` | ✅ OK | 404 | 5ms |
| 12 | POST | `/registry/classifiers/pending/{pending_id}/reject` | ✅ OK | 404 | 7ms |
| 13 | POST | `/registry/classifiers/validate` | ✅ OK | 500 | 5ms |
</details>
...
| 2 | POST | `/registry/documents` | ✅ OK | 307 | 2ms |
| 3 | GET | `/registry/documents` | ✅ OK | 307 | 1ms |
| 4 | GET | `/registry/documents/{doc_id}` | ✅ OK | 404 | 6ms |
| 5 | PUT | `/registry/documents/{doc_id}` | ✅ OK | 404 | 5ms |
| 6 | PATCH | `/registry/documents/{doc_id}/status` | ✅ OK | 404 | 5ms |
| 7 | GET | `/registry/documents/{doc_id}/history` | ✅ OK | 404 | 6ms |
| 8 | GET | `/registry/documents/{doc_id}/succession` | ✅ OK | 404 | 3ms |
| 9 | DELETE | `/registry/documents/{doc_id}` | ✅ OK | 404 | 5ms |
| 10 | GET | `/registry/documents/export` | ✅ OK | 500 | 7ms |
| 11 | POST | `/registry/documents/import` | ✅ OK | 422 | 2ms |
</details>
...
| 4 | GET | `/registry/terminology/{term_id}` | ✅ OK | 404 | 5ms |
| 5 | GET | `/registry/terminology/normalize` | ✅ OK | 500 | 6ms |
| 6 | PUT | `/registry/terminology/{term_id}` | ✅ OK | 404 | 8ms |
| 7 | DELETE | `/registry/terminology/{term_id}` | ✅ OK | 404 | 3ms |
| 8 | POST | `/registry/terminology/import` | ✅ OK | 422 | 2ms |
</details>
...
| 2 | GET | `/registry/enums` | ✅ OK | 500 | 8ms |
</details>
...
_Report generated by `api_coverage_test.py` at 2026-06-10 08:30:55 UTC_
