...
def get_service_def() -> ServiceDef:
    ...
    prepare_endpoints = [
        ...
        EndpointDef("POST", f"{API_PREFIX}/registry/classifiers", "classifiers",
            ...
            # docs: data.classifier_system, data.code, data.full_name, data.status
        ...
        EndpointDef("POST", f"{API_PREFIX}/registry/documents", "documents",
            ...
            extract_keys=["doc_id"],
            # docs: data.document_id (int), data.version_id (int), data.sections (list), data.registry (dict)
        ...
        EndpointDef("POST", f"{API_PREFIX}/registry/terminology", "terminology",
            ...
            # docs: data.id, data.raw_term, data.standard_term, data.normalized_value, data.term_type
