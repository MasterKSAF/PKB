...
**Generated:** 2026-06-10 09:14:27 UTC
...
| [Registry Service](#registry) | 8084 | ✅ | 35 | 17 | <span style="color:red;font-weight:bold">18</span> | 0 | <span style="color:red;font-weight:bold">❌</span> |
...
| **Total** | | **5/5** | **64** | **25** | <span style="color:red;font-weight:bold">39</span> | 0 | <span style="color:red;font-weight:bold">❌</span> |
...
| 3 | POST | `/auth/token` | ✅ OK | 200 | 236ms |
...
| 2 | POST | `/admin/users` | ❌ Error: HTTP 404 | 404 | 1ms |
| 3 | GET | `/admin/users/{user_id}` | ❌ Error: HTTP 404 | 404 | 2ms |
| 4 | PUT | `/admin/users/{user_id}` | ❌ Error: HTTP 404 | 404 | 2ms |
| 5 | PATCH | `/admin/users/{user_id}` | ❌ Error: HTTP 404 | 404 | 3ms |
...
**Total:** 35 | **Passed:** 17 | **Failed:** <span style="color:red;font-weight:bold">18</span> | **Skipped:** 0
...
| 2 | POST | `/registry/classifiers/` | ❌ Error: HTTP 409 | 409 | 11ms |
| 3 | GET | `/registry/classifiers/` | ✅ OK | 200 | 7ms |
| 4 | GET | `/registry/classifiers/tree/` | ✅ OK | 307 | 1ms |
| 5 | GET | `/registry/classifiers/{classifier_code}` | ❌ Error: HTTP 422 | 422 | 5ms |
| 6 | PUT | `/registry/classifiers/{classifier_code}` | ❌ Error: HTTP 422 | 422 | 5ms |
| 7 | PATCH | `/registry/classifiers/{classifier_code}` | ❌ Error: HTTP 422 | 422 | 4ms |
| 8 | DELETE | `/registry/classifiers/{classifier_code}` | ❌ Error: HTTP 422 | 422 | 5ms |
| 9 | POST | `/registry/classifiers/import/` | ✅ OK | 307 | 4ms |
| 10 | GET | `/registry/classifiers/pending/` | ✅ OK | 307 | 3ms |
...
| 13 | POST | `/registry/classifiers/validate/` | ✅ OK | 307 | 2ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/registry/documents/` | ✅ OK | 409 | 13ms |
| 2 | POST | `/registry/documents/` | ❌ Error: HTTP 409 | 409 | 10ms |
| 3 | GET | `/registry/documents/` | ✅ OK | 200 | 8ms |
| 4 | GET | `/registry/documents/{doc_id}` | ❌ Error: HTTP 404 | 404 | 7ms |
| 5 | PUT | `/registry/documents/{doc_id}` | ❌ Error: HTTP 404 | 404 | 12ms |
...
| 8 | GET | `/registry/documents/{doc_id}/succession` | ❌ Error: HTTP 404 | 404 | 5ms |
| 9 | DELETE | `/registry/documents/{doc_id}` | ❌ Error: HTTP 404 | 404 | 10ms |
| 10 | GET | `/registry/documents/export/` | ✅ OK | 307 | 3ms |
| 11 | POST | `/registry/documents/import/` | ✅ OK | 307 | 1ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/registry/terminology/` | ✅ OK | 409 | 9ms |
| 2 | POST | `/registry/terminology/` | ❌ Error: HTTP 409 | 409 | 9ms |
| 3 | GET | `/registry/terminology/` | ✅ OK | 200 | 9ms |
| 4 | GET | `/registry/terminology/{term_id}` | ❌ Error: HTTP 404 | 404 | 6ms |
| 5 | GET | `/registry/terminology/normalize/` | ✅ OK | 307 | 3ms |
| 6 | PUT | `/registry/terminology/{term_id}` | ❌ Error: HTTP 404 | 404 | 6ms |
| 7 | DELETE | `/registry/terminology/{term_id}` | ❌ Error: HTTP 404 | 404 | 6ms |
| 8 | POST | `/registry/terminology/import/` | ✅ OK | 307 | 4ms |
</details>
...
| 2 | POST | `/converter/convert` | ✅ OK | 200 | 51ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/validate/document` | ✅ OK | 200 | 48ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/rag/build` | ❌ Error: HTTP 422 | 422 | 11ms |
| 2 | POST | `/rag/build` | ❌ Error: HTTP 422 | 422 | 4ms |
| 3 | DELETE | `/rag/build/{doc_id}` | ❌ Error: HTTP 422 | 422 | 4ms |
| 4 | GET | `/rag/build/{doc_id}/status` | ❌ Error: HTTP 422 | 422 | 9ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | GET | `/health` | ❌ Error: HTTP 404 | 404 | 4ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/rag/search` | ❌ Error: HTTP 500 | 500 | 3035ms |
</details>
...
| Variable | Value |
|----------|-------|
| `access_token` | `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..cPMoJH_y4zaRkXpijaKgJmb3Zp9Zt2mH8BQj4_Zmq7o` |
| `refresh_token` | `GCsE1ZEPhHJaZS7lAeKrDNXm5icOUSLdTYBFOnKEZDu_h51s0IYfunFMiET0eGF-` |
| `classifier_code` | `DUPLICATE_CODE` |
## 📖 Legend
...
_Report generated by `api_coverage_test.py` at 2026-06-10 09:14:27 UTC_
