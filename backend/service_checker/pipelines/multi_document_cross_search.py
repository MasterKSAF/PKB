...
- Шаги RAG Builder build (9, 16): ожидают document_id как UUID, но registry возвращает int.
  Сервис может вернуть 422. Это известная проблема (specificity.md §25).
  Шаги будут FAILED — пайплайн это честно покажет.
"""
