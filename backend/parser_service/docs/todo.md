05.07.2026 внесены изменения:
- добавлен модуль замены парсера docling от Игоря Ж.


01.07.2026 внесены изменения:
- подключен гибридный режим, 
- повышена скорость обработки,
- улучшенно распознавание текстового слоя (теперь ошибка кодировки обрабатывается), 
- добавлены косвенные метрики оценки качества (в блоке "quality")
- добавлен вывод предположительно проблемных страничек (в блоке "notifications":[{..., "message":"problematic_pages: [3,  353, 389]"}]}, ) , и 
- добавлен модуль проверки качества текстового слоя PDF от Павла С. (в блоке "notifications":[{"category":"quality: GOOD", ...}, ...) .
