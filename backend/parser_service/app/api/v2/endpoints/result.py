"""
Эндпоинт GET /parser/process/{task_id}/result для API версии 2.
...
from app.api.v2.schemas import ResultResponse, ResultMetadata, ParserInfo
...
async def get_task_result(task_id: int):
    """
    Получает результат выполненной задачи в формате v2.
