...
class ChatSession(Base):
    ...
    session_id: Mapped[str] = mapped_column(String(64), primary_key=True, default=lambda: new_id("sess-"))
...
class ChatSource(Base):
    ...
    message_id: Mapped[str] = mapped_column(ForeignKey("chat_messages.message_id", ondelete="CASCADE"))
...
class ChatFeedback(Base):
    ...
    message_id: Mapped[str | None] = mapped_column(ForeignKey("chat_messages.message_id", ondelete="SET NULL"))
    answer_id: Mapped[str | None] = mapped_column(String(64))
...
class ChatExport(Base):
    ...
    export_id: Mapped[str] = mapped_column(String(64), primary_key=True, default=lambda: new_id("exp-"))
