...
class Settings:
    ...
    MOCK_RAG_ENABLED: bool = os.getenv("MOCK_RAG_ENABLED", "false").lower() == "true"
    MOCK_REGISTRY_ENABLED: bool = os.getenv("MOCK_REGISTRY_ENABLED", "false").lower() == "true"
    MOCK_LLM_ENABLED: bool = os.getenv("MOCK_LLM_ENABLED", "false").lower() == "true"
