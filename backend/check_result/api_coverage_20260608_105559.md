...
**Generated:** 2026-06-08 05:56:10 UTC
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/auth/token` | ✅ OK | 200 | 219ms |
| 2 | GET | `/auth/me` | ❌ Error: Поле 'email' обязательно, но не найдено в ответе | 200 | 5ms |
| 3 | POST | `/auth/refresh` | ✅ OK | 200 | 3ms |
| 4 | POST | `/auth/revoke` | ✅ OK | 200 | 2ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | GET | `/admin/users` | ✅ OK | 403 | 2ms |
| 2 | POST | `/admin/users` | ✅ OK | 403 | 2ms |
| 3 | GET | `/admin/users/{user_id}` | ✅ OK | 403 | 1ms |
| 4 | PUT | `/admin/users/{user_id}` | ✅ OK | 403 | 2ms |
| 5 | PATCH | `/admin/users/{user_id}` | ✅ OK | 403 | 2ms |
| 6 | DELETE | `/admin/users/{user_id}` | ✅ OK | 403 | 2ms |
| 7 | GET | `/admin/roles` | ✅ OK | 403 | 1ms |
| 8 | POST | `/admin/roles` | ✅ OK | 403 | 2ms |
| 9 | GET | `/admin/audit` | ✅ OK | 403 | 1ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/internal/auth/validate` | ✅ OK | 200 | 2ms |
</details>
...
| 2 | POST | `/converter/convert` | ✅ OK | 200 | 3365ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/validate/document` | ✅ OK | 200 | 3333ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/files/upload` | ✅ OK | 422 | 3ms |
...
| 13 | GET | `/documents/queue` | ✅ OK | 200 | 1ms |
| 14 | GET | `/documents/{doc_id}/pages` | ✅ OK | 200 | 1ms |
| 15 | GET | `/documents/{doc_id}/pages/{page_num}` | ✅ OK | 422 | 2ms |
| 16 | GET | `/documents/{doc_id}/pages/{page_num}/text` | ✅ OK | 422 | 3ms |
| 17 | GET | `/documents/{doc_id}/pages/{page_num}/preview` | ✅ OK | 422 | 6ms |
...
| 2 | GET | `/documents/search` | ✅ OK | 200 | 4ms |
</details>
...
| 2 | GET | `/system/health` | ✅ OK | 404 | 7ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/chat/sessions` | ❌ Error: Поле 'session_id' ожидалось str, получен int = 2 | 201 | 10ms |
| 2 | GET | `/chat/sessions` | ✅ OK | 200 | 9ms |
...
| 13 | GET | `/chat/history` | ✅ OK | 200 | 8ms |
| 14 | GET | `/chat/history/export` | ✅ OK | 200 | 4ms |
</details>
...
| 2 | DELETE | `/rag/build/{doc_id}` | ✅ OK | 422 | 2ms |
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/rag/search` | ❌ Error: HTTP 500 | 500 | 4ms |
</details>
...
| Variable | Value |
|----------|-------|
| `access_token` | `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1LTAwMiIsInR5cGUiOiJhY2Nlc3MiLCJleHAiOjE3ODA5MDE3NjJ9.wYn4KXuFuT8mE28QdKj209Hnk3PcFPdYH6VE_P0UJ8U` |
| `refresh_token` | `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1LTAwMiIsInR5cGUiOiJyZWZyZXNoIiwiZXhwIjoxNzgzNDkwMTYyLCJqdGkiOiIwMjE1Zjc4NmYwYzM0MDY0YmFhMmNhYjZjMGQ5NzgzYyJ9.tRF5eNjOcLMeaogWuxFjkqdEtpl4ck4hg-jXZa4VADs` |
| `session_id` | `2` |
## 📖 Legend
...
_Report generated by `api_coverage_test.py` at 2026-06-08 05:56:10 UTC_
