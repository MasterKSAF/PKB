...
**Generated:** 2026-06-08 07:08:09 UTC
...
| **Total** | | **116** | **61** | <span style="color:red;font-weight:bold">2</span> | <span style="color:red;font-weight:bold">53</span> | **7/10** |
...
| 2 | POST | `/converter/convert` | ✅ OK | 200 | 3322ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/files/upload` | ✅ OK | 422 | 1ms |
...
| 17 | GET | `/documents/{doc_id}/pages/{page_num}/preview` | ✅ OK | 422 | 4ms |
| 18 | GET | `/documents/{doc_id}/parameters` | ✅ OK | 200 | 2ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/chat/sessions` | ❌ Error: Поле 'session_id' ожидалось str, получен int = 8 | 201 | 9ms |
| 2 | GET | `/chat/sessions` | ✅ OK | 200 | 12ms |
| 3 | GET | `/chat/sessions/{session_id}` | ✅ OK | 422 | 4ms |
| 4 | PUT | `/chat/sessions/{session_id}` | ✅ OK | 422 | 3ms |
| 5 | POST | `/chat/sessions/{session_id}/messages` | ✅ OK | 422 | 5ms |
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/text/search` | ✅ OK | 200 | 2ms |
| 2 | POST | `/text/ask` | ✅ OK | 200 | 2ms |
</details>
...
_Report generated by `api_coverage_test.py` at 2026-06-08 07:08:09 UTC_
