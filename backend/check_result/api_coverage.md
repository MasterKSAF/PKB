...
**Generated:** 2026-06-17 18:09:18 UTC
...
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/auth/token` | ✅ OK | 200 | 249ms |
| 2 | GET | `/auth/me` | ✅ OK | 200 | 9ms |
| 3 | POST | `/auth/token` | ✅ OK | 200 | 232ms |
...
| 4 | GET | `/admin/users/{user_id}` | ✅ OK | 200 | 10ms |
| 5 | PUT | `/admin/users/{user_id}` | ✅ OK | 200 | 25ms |
| 6 | PATCH | `/admin/users/{user_id}` | ✅ OK | 200 | 20ms |
| 7 | DELETE | `/admin/users/{user_id}` | ✅ OK | 200 | 24ms |
| 8 | GET | `/admin/roles` | ✅ OK | 200 | 14ms |
| 9 | POST | `/admin/roles` | ✅ OK | 201 | 19ms |
| 10 | GET | `/admin/audit` | ✅ OK | 200 | 15ms |
</details>
...
| 3 | GET | `/registry/classifiers/` | ✅ OK | 200 | 9ms |
| 4 | GET | `/registry/classifiers/tree/` | ✅ OK | 200 | 7ms |
| 5 | GET | `/registry/classifiers/{classifier_code}` | ✅ OK | 200 | 13ms |
| 6 | PUT | `/registry/classifiers/{classifier_code}` | ✅ OK | 200 | 13ms |
| 7 | PATCH | `/registry/classifiers/{classifier_code}` | ✅ OK | 200 | 13ms |
| 8 | DELETE | `/registry/classifiers/{classifier_code}` | ✅ OK | 200 | 20ms |
| 9 | POST | `/registry/classifiers/import` | ✅ OK | 422 | 6ms |
| 10 | GET | `/registry/classifiers/pending` | ✅ OK | 200 | 9ms |
| 11 | POST | `/registry/classifiers/pending/{pending_id}/accept` | ✅ OK | 200 | 19ms |
| 12 | POST | `/registry/classifiers/pending/{pending_id}/reject` | ✅ OK | 200 | 17ms |
| 13 | POST | `/registry/classifiers/validate` | ✅ OK | 200 | 8ms |
</details>
...
| 2 | GET | `/registry/documents/` | ✅ OK | 200 | 11ms |
| 3 | GET | `/registry/documents/{doc_id}` | ✅ OK | 200 | 7ms |
| 4 | PUT | `/registry/documents/{doc_id}` | ✅ OK | 200 | 16ms |
| 5 | PATCH | `/registry/documents/{doc_id}/status` | ✅ OK | 200 | 17ms |
| 6 | GET | `/registry/documents/{doc_id}/history` | ✅ OK | 200 | 9ms |
| 7 | GET | `/registry/documents/{doc_id}/succession/` | ✅ OK | 200 | 6ms |
| 8 | DELETE | `/registry/documents/{doc_id}` | ✅ OK | 200 | 12ms |
| 9 | GET | `/registry/documents/export` | ✅ OK | 200 | 8ms |
| 10 | POST | `/registry/documents/import` | ✅ OK | 422 | 6ms |
</details>
...
| 2 | GET | `/registry/terminology/` | ✅ OK | 200 | 9ms |
| 3 | GET | `/registry/terminology/{term_id}` | ✅ OK | 200 | 8ms |
| 4 | GET | `/registry/terminology/normalize/` | ✅ OK | 200 | 7ms |
| 5 | PUT | `/registry/terminology/{term_id}` | ✅ OK | 200 | 13ms |
| 6 | DELETE | `/registry/terminology/{term_id}` | ✅ OK | 200 | 11ms |
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | GET | `/registry/stats` | ✅ OK | 200 | 14ms |
| 2 | GET | `/registry/enums` | ✅ OK | 200 | 7ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/converter/preview/metadata` | ✅ OK | 200 | 8ms |
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/validate/document` | ✅ OK | 200 | 40ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/parser/process` | ✅ OK | 202 | 44ms |
| 2 | POST | `/parser/process` | ✅ OK | 202 | 6ms |
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/auth/token` | ✅ OK | 200 | 344ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/drafts/` | ✅ OK | 202 | 806ms |
| 2 | POST | `/drafts/` | ✅ OK | 202 | 22ms |
| 3 | GET | `/drafts/` | ✅ OK | 200 | 5ms |
| 4 | GET | `/drafts/{draft_id}` | ✅ OK | 200 | 4ms |
| 5 | DELETE | `/drafts/{draft_id}` | ✅ OK | 204 | 4ms |
| 6 | PATCH | `/drafts/{draft_id}/decide` | ✅ OK | 422 | 55ms |
| 7 | GET | `/drafts/{draft_id}/preview` | ✅ OK | 404 | 5ms |
| 8 | POST | `/drafts/{draft_id}/preview` | ✅ OK | 404 | 5ms |
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | GET | `/system/health` | ✅ OK | 200 | 11ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | GET | `/monitor/metrics` | ✅ OK | 200 | 10ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | GET | `/tasks/{task_id}/status` | ✅ OK | 200 | 44ms |
</details>
...
| 5 | GET | `/documents/{doc_id}/status` | ✅ OK | 200 | 6ms |
| 6 | GET | `/documents/{doc_id}/file` | ✅ OK | 200 | 5ms |
| 7 | GET | `/documents/{doc_id}/history` | ✅ OK | 200 | 5ms |
| 8 | GET | `/documents/{doc_id}/errors` | ✅ OK | 200 | 32ms |
| 9 | GET | `/documents/{doc_id}/versions` | ✅ OK | 200 | 5ms |
| 10 | POST | `/documents/{doc_id}/versions` | ✅ OK | 422 | 4ms |
| 11 | POST | `/documents/{doc_id}/approve` | ✅ OK | 202 | 5ms |
| 12 | POST | `/documents/{doc_id}/reprocess` | ✅ OK; ⚠️ Поле 'task_id' ожидалось int, получен str = task-repro-e968b205 | 202 | 5ms |
...
| 17 | GET | `/documents/{doc_id}/parameters` | ✅ OK | 200 | 6ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/documents/search` | ✅ OK | 200 | 53ms |
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/chat/sessions` | ✅ OK | 201 | 74ms |
| 2 | POST | `/chat/sessions/{session_id}/messages` | ✅ OK | 202 | 22ms |
| 3 | POST | `/chat/sessions` | ✅ OK | 201 | 7ms |
| 4 | GET | `/chat/sessions` | ✅ OK | 200 | 15ms |
| 5 | GET | `/chat/sessions/{session_id}` | ✅ OK | 200 | 8ms |
| 6 | PUT | `/chat/sessions/{session_id}` | ✅ OK | 200 | 12ms |
| 7 | POST | `/chat/sessions/{session_id}/messages` | ✅ OK | 202 | 13ms |
| 8 | GET | `/chat/sessions/{session_id}/messages/last` | ✅ OK | 200 | 36ms |
| 9 | GET | `/chat/sessions/{session_id}/messages` | ✅ OK | 200 | 10ms |
| 10 | GET | `/chat/sessions/{session_id}/messages/{message_id}` | ✅ OK | 200 | 9ms |
| 11 | POST | `/chat/sessions/{session_id}/context` | ✅ OK | 200 | 6ms |
| 12 | POST | `/chat/sessions/{session_id}/export` | ✅ OK | 200 | 12ms |
| 13 | POST | `/chat/feedback` | ✅ OK | 200 | 62ms |
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/auth/token` | ✅ OK | 200 | 229ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/registry/documents/` | ✅ OK | 201 | 11ms |
</details>
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/rag/build` | ✅ OK | 201 | 32ms |
| 2 | POST | `/rag/build` | ✅ OK | 201 | 10ms |
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/rag/search` | ✅ OK | 200 | 419ms |
</details>
...
| 7 | POST | `/internal/auth/validate` | ✅ OK | 200 | 4ms |
</details>
...
| 21 | DELETE | `/chat/sessions/{session_id}` | ✅ OK | 200 | 4ms |
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | POST | `/registry/classifiers` | ✅ OK | 201 | 8ms |
| 2 | GET | `/registry/classifiers` | ✅ OK | 200 | 4ms |
| 3 | POST | `/registry/classifiers` | ✅ OK | 409 | 3ms |
| 4 | GET | `/registry/classifiers/tree` | ✅ OK | 200 | 4ms |
| 5 | GET | `/registry/classifiers/{code}` | ✅ OK | 200 | 3ms |
| 6 | PUT | `/registry/classifiers/{code}` | ✅ OK | 200 | 5ms |
| 7 | PATCH | `/registry/classifiers/{code}` | ✅ OK | 200 | 4ms |
| 8 | POST | `/registry/classifiers/import` | ✅ OK | 200 | 5ms |
| 9 | GET | `/registry/classifiers/quarantine` | ✅ OK | 200 | 4ms |
| 10 | POST | `/registry/classifiers/quarantine/{pending_id}/accept` | ✅ OK | 200 | 5ms |
| 11 | POST | `/registry/classifiers/quarantine/{pending_id}/reject` | ✅ OK | 200 | 5ms |
| 12 | POST | `/registry/classifiers/validate` | ✅ OK | 200 | 5ms |
...
| 4 | POST | `/registry/documents` | ✅ OK | 201 | 3ms |
...
| 13 | POST | `/registry/documents/check-uniqueness` | ✅ OK | 200 | 6ms |
| 14 | POST | `/registry/drafts` | ✅ OK | 201 | 4ms |
| 15 | GET | `/registry/drafts` | ✅ OK | 200 | 5ms |
| 16 | GET | `/registry/drafts/{reg_draft_id}` | ✅ OK | 200 | 4ms |
| 17 | GET | `/registry/drafts/{reg_draft_id}/preview` | ✅ OK | 200 | 4ms |
| 18 | PATCH | `/registry/drafts/{reg_draft_id}/status` | ✅ OK | 200 | 4ms |
...
| 4 | GET | `/registry/categories/{category_id}` | ✅ OK | 200 | 5ms |
| 5 | PUT | `/registry/categories/{category_id}` | ✅ OK | 200 | 5ms |
...
| 6 | GET | `/drafts/{draft_id}/preview` | ✅ OK | 200 | 3ms |
...
| # | Method | Path | Status | Code | Time |
|---|--------|------|--------|:----:|:----:|
| 1 | GET | `/tasks/{task_id}/status` | ✅ OK | 200 | 4ms |
</details>
...
_Report generated by `api_coverage_test.py` at 2026-06-17 18:09:18 UTC_
