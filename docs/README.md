...
│
├── docs_discussions/                 # Исторические обсуждения архитектуры (вне docs/)
│   ├── plans/                        #   Планы встреч по номерам
│   │   ├── 1.23_05_26.md
│   │   ├── 2.26_05_26.md
│   │   └── 3.04_06_26.md
│   ├── features/                     #   Feature-спеки
│   │   ├── rag_experiments_methodology.md
│   │   └── rag_evaluation_methodology.md
│   ├── итоги вcтречи 25.05.26.md
│   ├── итоги вcтречи 26.05.26.md
│   ├── итоги встречи 27.05.26.md
│   ├── итоги встречи 01.06.26.md
│   ├── итоги встречи 2 гр 03.06.26.md
│   ├── итоги общей встречи 03.06.26.md
│   ├── Итоги встречи (совещание от 2026-06-02).md
