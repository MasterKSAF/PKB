...
| Поиск | 1. RAG поиск чанков | **Читает** | Вход: query + filters → Выход: массив чанков |
| Поиск | 2. Генерация ответа LLM | **Нет** | Вход: чанки → Выход: текст ответа |
| Поиск | 3. Обогащение цитирований | **Нет** | Вход: текст LLM + чанки → Выход: answer с аннотированными сносками |
...
| Поиск чанков | 3 | 1. RAG поиск | **RAG Service** | Читает |
| Генерация ответа LLM | 3 | 2. Query Service | **Query Service** | Нет |
| Обогащение цитирований | 3 | 3. Query Service | **Query Service** | Нет |
